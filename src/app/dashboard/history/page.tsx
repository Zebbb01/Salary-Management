...
import { SpareAmountChart } from '@/features/salary/components/history/spare-amount-chart';
import { IncomeExpensesChart } from '@/features/salary/components/history/income-expenses-chart';
import { CombinedCashflowTrends } from '@/features/salary/components/history/combined-cashflow-trends';
import { ConsumableBudgetTrend } from '@/features/salary/components/history/consumable-budget-trend';
import { BorrowingActivityChart } from '@/features/salary/components/history/borrowing-activity-chart';
import {
...
// Trend Chart
// ---------------------------------------------------------------------------
// SpareChartTooltip deleted (imported inside modular components)

// SpareAmountChart deleted (imported from feature component library)
...
// ---------------------------------------------------------------------------
// IncomeExpensesChartTooltip deleted (imported inside modular components)

// IncomeExpensesChart deleted (imported from feature component library)
          ...
          <TabsContent value="consumable" className="space-y-6">
            {isLoadingTab ? <HistorySkeleton /> : consumableRecords.length === 0 ? (
              ...
              <>
                ...
                <ConsumableBudgetTrend
                  consumableRecords={consumableRecords}
                  isMobile={isMobile}
                />
              </>
            )}
